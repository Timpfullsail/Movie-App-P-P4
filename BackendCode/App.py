...
def recommend_movies():
    ...
    recommendations = Reccomend.get_movie_recommendations(movie_title)
...
def recommend_anime():
    ...
    recommendations = Animie_Recomment.get_anime_recommendations(anime_title)
    return jsonify({"recommendations": recommendations})
